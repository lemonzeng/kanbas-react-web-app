...
export default function Assignments() {
  const { cid } = useParams(); 
  console.log(`Now the course id is : ` + cid);
  ...
  useEffect(() => {
    if(courseAssignments && courseAssignments.length > 0){
      console.log("Assignemnts loaded successfully: ", courseAssignments);
    }else{
      console.log('No assignments found or assignments not loaded yet.')
    }
  })
